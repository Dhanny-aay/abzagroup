    ...
    return ( 
        ...
        <div className=" mt-4 md:mt-14 px-3 md:px-16">
            <div className=" flex flex-col md:flex-row items-center justify-around space-y-4 md:space-y-0">
                <div className=" w-full md:w-[350px]">
                    <div className=" w-full h-[380px] bg-black rounded-[20px] biztwo bg-cover"></div>
                    <p className=" font-Mulish text-xl font-normal mt-3">Azba Farms and Foods Ltd</p>
                </div>
                <div className=" w-full md:w-[350px]">
                    <div className=" w-full h-[380px] bg-black rounded-[20px] bizthree bg-cover"></div>
                    <p className=" font-Mulish text-xl font-normal mt-3">Azba Consulting Ltd</p>
                </div>
                <div className=" w-full md:w-[350px]">
                    <div className=" w-full h-[380px] bg-black rounded-[20px] bizfour bg-cover"></div>
        ...
        <div className=" mt-4 md:mt-14 px-3 md:px-16">
            <div className=" flex flex-col md:flex-row justify-around space-y-4 md:space-y-0">
                <div className=" w-full md:w-[350px]">
                    <div className=" w-full h-[380px] bg-black rounded-[20px] bizfive bg-cover"></div>
                    <p className=" font-Mulish text-xl font-normal mt-3">Azba Trading Ltd</p>
                </div>
                <div className=" w-full md:w-[350px]">
                    <div className=" w-full h-[380px] bg-black rounded-[20px] bizsix bg-cover"></div>
                    <p className=" font-Mulish text-xl font-normal mt-3">Azba Logistics</p>
                </div>
                <div className=" w-full md:w-[350px]">
                    <div className=" w-full h-[380px] bg-black rounded-[20px] bizseven bg-cover"></div>
